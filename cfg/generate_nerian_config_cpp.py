...
%s
    ...
    // Publish them
    ROS_INFO("autogen_updateConfigFromDevice - min");
    dynReconfServer->setConfigMin(config_min);
    ROS_INFO("autogen_updateConfigFromDevice - max");
    dynReconfServer->setConfigMax(config_max);
    ROS_INFO("autogen_updateConfigFromDevice - def");
    dynReconfServer->setConfigDefault(config_default);
    ROS_INFO("autogen_updateConfigFromDevice - Done.");
}
'''
